...
function addMarker(place)
{
    ...
    // On double click just go to the first article
    google.maps.event.addListener(marker, "dblclick", function() {
        ...
        {
            var article = data;
            window.location.href = article[1].link;
        }) 
    });
    
    // On click, show a list of articles
    google.maps.event.addListener(marker, "click", function() {
        ...
        .done(function(data, textStatus, jqXHR)
        {
            ...
            {
                resultHTML += "<LI><A HREF=\"" + article[i].link + "\">" + article[i].title + "</LI>";
            }      
            resultHTML += "</UL>";
            if (resultHTML == "<UL>")
            {
                resultHTML = "No news today!";
            }
            showInfo(marker, resultHTML);
        }) 
    });
